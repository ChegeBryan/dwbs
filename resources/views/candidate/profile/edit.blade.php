    ...
    <div class="card-body">
      <div class="form-group">
        ...
        <select class="custom-select  @error('category') is-invalid @enderror" name="category" id="category" required>
          <option @if ($profile->category)=== 'House Help') selected @endif value="House Help">House Help</option>
          <option @if ($profile->category)=== 'Shamba Boy') selected @endif value="Shamba Boy">Shamba Boy</option>
        </select>
      ...
      <div class="form-row">
        <div class="col">
          ...
          <input id="county" type="text" class="form-control @error('county') is-invalid @enderror"
                 placeholder="Nairobi" name="county" value="{{ $profile->county }}" required>
          @error('county')
          <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
          </span>
        ...
        <div class="col">
          ...
          <input id="town" type="text" class="form-control @error('town') is-invalid @enderror" placeholder="Kasarani"
                 name="town" value="{{ $profile->town }}" required>
          @error('county')
          <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
          </span>
