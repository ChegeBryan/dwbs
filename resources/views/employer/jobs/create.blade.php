...
<form method="POST" action="{{route('jobs.store')}}">
  ...
  <!-- About job-->
  <div class=" card">
    <div class="card-header bg-gradient-primary text-white">Post New Job</div>
    <div class="card-body">
      ...
      <div class="form-row">
        ...
        <div class="col">
          ...
          <input id="salary" type="number" class="form-control @error('salary') is-invalid @enderror" name="salary"
                 value="{{ old('salary') }}" placeholder="15000" required>
          @error('salary')
          <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
          </span>
  ...
  <!--JOb description -->
  <div class="card my-4">
    <div class="card-header bg-gradient-primary text-white">About Job</div>
    <div class="card-body">
      <div class="form-group">
        ...
        <textarea class="form-control @error('job_description') is-invalid @enderror" rows="4" name="job_description"
                  placeholder="A description of what the job will involve."></textarea>
  ...
  <div class="card my-4">
    <div class="card-header bg-gradient-primary text-white">Address and Location</div>
    <div class="card-body">
      <div class="form-row">
        <div class="col">
